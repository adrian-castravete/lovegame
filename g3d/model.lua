...
function model:makeNormals(isFlipped)
    for i=1, #self.verts, 3 do
        ...
        local t1, t2, t3 = vectorNormalize(v[1]-vp[1], v[2]-vp[2], v[3]-vp[3])
        local u1, u2, u3 = vectorNormalize(vn[1]-v[1], vn[2]-v[2], vn[3]-v[3])
        local n_1, n_2, n_3 = vectorCrossProduct(t1, t2, t3, u1, u2, u3)
